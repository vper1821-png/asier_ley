...
const TOUR_STEPS = [
    ...
    { page: '/payments', sel: 'main', title: 'Pagos', text: 'Gestiona los pagos y facturación de tu plan: pagos pendientes, historial y comprobantes de transferencia.' },
    ...
    { page: '/dashboard', sel: '.tour-notifications', title: 'Notificaciones', text: 'Campana de notificaciones con alertas de seguridad, avisos de pagos y novedades de la plataforma en tiempo real.' },
