...
window.downloadMeasurePDF = function(measureId, measureLabel) {
    ...
    if (Object.keys(fieldData).length === 0) {
        rows = '<tr><td colspan="2" style="padding:8px;">No hay datos registrados para esta medida.</td></tr>';
    } else {
        Object.keys(fieldData).forEach(key => {
            const label = key.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase());
            rows += '<tr><td style="padding:7px 8px;font-weight:bold;width:40%;">' + escapeHtml(label) + '</td><td style="padding:7px 8px;">' + escapeHtml(fieldData[key]) + '</td></tr>';
        });
    }
    ...
    const html = '<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><title>' + escapeHtml(def.label) + '</title><style>body{font-family:Helvetica,Arial,sans-serif;font-size:11px;line-height:1.6;color:#1a1a1a;max-width:800px;margin:0 auto;padding:0;background-color:#ffffff;}.cover{text-align:center;padding:0 40px 20px 40px;}.cover-topline{height:2px;background:#000000;width:100%;margin-bottom:50px;}.cover-label{color:#777777;font-size:9px;letter-spacing:2px;}.cover-law{color:#777777;font-size:9px;margin-top:6px;}.cover-sep{border-top:1px solid #000000;margin:22px 80px 0 80px;}.cover-company{color:#1a1a1a;font-size:15px;font-weight:bold;margin-top:24px;text-transform:uppercase;}.cover-title{color:#1a1a1a;font-size:20px;font-weight:bold;margin-top:14px;}.cover-sub{color:#555555;font-size:11px;margin-top:20px;}.cover-box{background:#f5f5f5;border:1px solid #bbbbbb;margin:24px 110px 0 110px;padding:8px 10px;}.cover-box .lbl{color:#555555;font-size:8px;}.cover-box .val{color:#1a1a1a;font-size:11px;font-weight:bold;margin-top:3px;}.cover-box2{background:#f5f5f5;border:1px solid #bbbbbb;margin:12px 110px 0 110px;padding:8px;font-size:9px;font-weight:bold;}.content{padding:20px 40px;}.section{margin-bottom:22px;page-break-inside:avoid;padding:0;}.section h2{color:#1a1a1a;font-size:13px;border-left:4px solid #000000;padding:2px 0 2px 10px;margin-bottom:12px;font-weight:bold;}.section p{color:#1a1a1a;font-size:11px;margin:5px 0;}.legal-box{background:#f5f5f5;border:0.5px solid #bbbbbb;padding:16px;margin:18px 40px;}.legal-box h3{color:#1a1a1a;margin:0 0 8px 0;font-size:12px;}.legal-box p{color:#1a1a1a;margin:0;font-size:10px;line-height:1.6;}.footer{margin:25px 40px;padding:12px;border-top:0.5px solid #cccccc;background:#f5f5f5;text-align:center;}.footer p{color:#999999;margin:3px 0;font-size:9px;}table{width:100%;border-collapse:collapse;margin:12px 0;font-size:10px;}th{background:#1a1a1a;color:#cccccc;font-size:9px;font-weight:bold;text-align:left;padding:7px 8px;border:none;}td{color:#1a1a1a;padding:6px 8px;border:none;border-bottom:0.3px solid #e0e0e0;}tr:nth-child(even) td{background:#f1f5f9;}</style></head><body><div class="cover"><div class="cover-topline"></div><div class="cover-label">REPÚBLICA DE CHILE</div><div class="cover-law">Ley 21.719 - Protección de Datos Personales</div><div class="cover-sep"></div><div class="cover-company">SecureLab Admin</div><div class="cover-title">' + escapeHtml(def.label) + '</div><div class="cover-sub">Evidencia de Medida de Seguridad - Art. 25</div><div class="cover-sep"></div><div class="cover-box"><div class="lbl">FECHA DE EMISIÓN</div><div class="val">' + new Date().toLocaleDateString('es-CL') + '</div></div><div class="cover-box2">CLASIFICACIÓN: CONFIDENCIAL</div></div><div class="content"><div class="section"><h2>Descripción</h2><p style="color:#000000;font-size:14px;">' + escapeHtml(def.desc) + '</p></div><div class="legal-box"><h3>Marco Legal - Artículo 25 Ley 21.719</h3><p>Las organizaciones responsables de bases de datos deberán adoptar las medidas técnicas y organizativas necesarias para garantizar la seguridad de los datos personales, impidiendo accesos no autorizados, su destrucción, pérdida o alteración accidental o ilícita.</p></div><div class="section"><h2>Datos Registrados</h2><table>' + rows + '</table></div><div class="section"><h2>Evidencia y Notas</h2><p><strong>URL de evidencia:</strong> ' + (evidence ? evidence : 'No registrada') + '</p><p><strong>Notas:</strong> ' + (notes ? notes : 'Sin notas') + '</p><p><strong>Fecha de completitud:</strong> ' + completedAt + '</p></div><div class="footer"><p>Documento generado automáticamente por SecureLab</p><p>' + new Date().toLocaleDateString('es-CL') + '</p></div></body></html>'; // teString('es-CL') + '</p></div><div class="footer"><p>Este documento ha sido generado automáticamente por SecureLab</p><p>Fecha de generación: ' + new Date().toLocaleString('es-CL') + '</p><p>Este documento es válido como evidencia del cumplimiento de la Ley 21.719</p></div></body></html>';
