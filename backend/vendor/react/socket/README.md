...
```php
$socket = new React\Socket\SocketServer('ley.securelab.cl');
...
$connector->connect('ley.securelab.cl')->then(function (React\Socket\ConnectionInterface $connection) {
...
as `tcp://ley.securelab.cl`, `tcp://[::1]:80`, `tls://127.0.0.1:443`,
...
```php
$first = new React\Socket\SocketServer('ley.securelab.cl');

// throws RuntimeException because port is already in use
$second = new React\Socket\SocketServer('ley.securelab.cl');
```
...
```php
$socket = new React\Socket\SocketServer('tls://ley.securelab.cl', array(
    'tls' => array(
